...
# ======================
DAISY["himmilbeau"] = Dict("dom" => IntervalBox(a, b),
                           "numvars" => 2,
                           "vars" => "x1 x2",
...
DAISY["kepler1"] = Dict("dom" => IntervalBox(a, b, c, d, e, f),
                        "numvars" => 6,
...
DAISY["kepler2"] = Dict("dom" => IntervalBox(a, b, c, d),
                        "numvars" => 4,
                        "vars" => "x1 x2 x3 x4",
...
DAISY["kepler3"] = Dict("dom" => IntervalBox(a, b, c, d, e, f),
                        "numvars" => 6,
                        "vars" => "x1 x2 x3 x4 x5 x6",
...
DAISY["Rigidbody1"] = Dict("dom" => IntervalBox(a, b, c),
                           "numvars" => 3,
                           "vars" => "x1 x2 x3",
                           "f" => ((x1, x2, x3) -> -x1 * x2 - 2 * x2 * x3 - x1 - x3),
                           "ref" => Interval(-20.786552979420335, -0.540012836551535))

DAISY["Rigidbody2"] = Dict("dom" => IntervalBox(a, b, c),
                           "numvars" => 3,
                           "vars" => "x1 x2 x3",
