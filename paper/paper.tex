...
If a user wants to add a new solver, they just have to add a new struct, say, \texttt{MyEnclosure} and extend the method \texttt{enclose} with the algorithm implementation, as the following code snippet demonstrates.
%
